...
(deftest move-towards-target-position-tests
  (is (= (move-towards-target-height 50 0) move-up-full-speed))
  (is (= (move-towards-target-height 50 40) move-up-half-speed))
  (is (= (move-towards-target-height 50 50) stop))
  (is (= (move-towards-target-height 50 55) move-down-half-speed))
  (is (= (move-towards-target-height 50 100) move-down-full-speed)))
